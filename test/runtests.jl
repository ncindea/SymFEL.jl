...
M = SymFEL.assemble_1d_FE_matrix(elem_M, n, intNodes = 1, dof1 = 1, dof2 = 1)
...
M_h3 = SymFEL.assemble_1d_FE_matrix(elem_M_h3, n, intNodes = 0, dof1 = 2, dof2 = 2)
x = zeros(2 * n, 1)
...
elem_M_p1 = SymFEL.get_lagrange_em(1, 0, 0)
M_p1_nu = SymFEL.assemble_1d_nu_FE_matrix(elem_M_p1, nodes; intNodes = 0, dof1 = 1, dof2 = 1)
A = M_p1 - M_p1_nu
@test norm(A[:]) < 1e-15
##
...
M_p1_nu2 = SymFEL.assemble_1d_nu_FE_matrix(elem_M_p1, nodes; intNodes = 0, dof1 = 1, dof2 = 1)
x = nodes.^2
