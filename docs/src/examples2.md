...
```@example 2
elem_Mxy = SymFE.get_square_lagrange_em((2, 2), (0, 0), (0, 0))
elem_Kxy = SymFE.get_square_lagrange_em((2, 2), (1, 0), (1, 0)) +
    SymFE.get_square_lagrange_em((2, 2), (0, 1), (0, 1))
...
### global matrices
```@example 2
K = SymFE.assemble_squaremesh_FE_matrix(elem_Kxy_dx, elements_int, order1=2, order2=2)
M = SymFE.assemble_squaremesh_FE_matrix(elem_Mxy_dx, elements_int, order1=2, order2=2)
nothing #hide
```
...
The corresponding program can be downloaded [here](https://github.com/ncindea/SymFE.jl/blob/master/examples/ex4-bilaplacian2d.jl).
...
We use the mesh [simple-square.msh](https://github.com/ncindea/SymFE.jl/blob/master/examples/square-simple.msh) (in gmsh format).
...
```@example 3
elem_M = SymFE.get_square_hermite_em((3, 3), (0, 0), (0, 0))
elem_K = SymFE.get_square_hermite_em((3, 3), (2, 0), (2, 0)) +
    SymFE.get_square_hermite_em((3, 3), (2, 0), (0, 2)) +
    SymFE.get_square_hermite_em((3, 3), (0, 2), (2, 0)) +
    SymFE.get_square_hermite_em((3, 3), (0, 2), (0, 2))
...
```@example 3
K = SymFE.assemble_squaremesh_FE_matrix(elem_K_dx, elements_int,
                                           order1=1, order2=1,
                                           dof1=4, dof2=4)
M = SymFE.assemble_squaremesh_FE_matrix(elem_M_dx, elements_int,
                                           order1=1, order2 = 1,
                                           dof1=4, dof2=4)
nothing #hide
```
