...
nodes_boundary = convert(Array{Int64}, unique(gmsh.model.mesh.getNodesByElementType(3)[1]))
...
elements_bound = reshape(convert(Array{Int64}, elements[3][1]), (4, elements_bound_N))
elements_int = reshape(convert(Array{Int64}, elements[3][2]), (8, elements_int_N))
#gmsh.fltk.run()
gmsh.finalize()
